...
function Mentalhealth() {
  return (
    <div className="MHealth">
        ...
        In conclusion, KOSHUR SCIENTIST's mental health awareness program is an excellent initiative that provides much-needed support and guidance to students struggling with mental health issues. The program's focus on visiting different schools and organizing various events is an effective way to spread awareness and educate students about mental health. It is an excellent opportunity for students to learn about mental health and related issues and develop the necessary skills to deal with stress and anxiety. The program promotes a culture of openness and encourages
         students to seek help when needed, which is critical for their mental well-being.</p>
    </div>
  )
}
