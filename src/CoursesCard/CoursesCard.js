      ...
      <div className="flex-container">
        ...
        <div className="card-one">
          <img
            ...
            alt="brain"
          />
          <h1> Athwas </h1> <p> class 10 th </p> <p> 60 + lactures </p>{" "}
          <p> JKBOSE / CBSE </p> <p> complete Maths & Science </p>{" "}
        ...
        <div className="card-one">
          <img
            ...
            alt="bulb"
          />
          <h1> Aash </h1> <p> JKSSB </p> <p> 1000 + Questions </p>{" "}
          <p className="paragraph">
            {" "}
            complete General Science & Computer Science{" "}
          </p>{" "}
          <button className="button"> Explore Courses </button>{" "}
        </div>
        <div className="card-one">
